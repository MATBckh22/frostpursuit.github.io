...
const redstoneItems = [
    { src: "Overview.png", label: "Overview", description: "A complete view of the underlying redstone system used in Frost Pursuit, featuring timer, sorted leaderboards, and display modules working in unison." },
    { src: "Main Computations System.png", label: "Main Computations System", description: "The core logic system coordinates individual components, handling multiple player IDs and their ranking data to facilitate seamless race management." },
    { src: "Initial Race Registration UI.png", label: "Initial Race Registration UI", description: "The starting point for new racers to register. Accepts 63 named items, splitting into IDs and sorting placeholders for the system." },
    { src: "Race Whitelist Login UI.png", label: "Race Whitelist Login UI", description: "Stores historic registrations for returning players to login. It functions as a whitelist checker at the finish line to verify IDs before recording scores." },
    { src: "3-Layer Timer with Shift Registers.png", label: "3-Layer Timer with Shift Registers", description: "A high-precision clock down to the seconds. Uses synchronous carry logic to prevent display ghosting." },
    { src: "3-bit Adder.png", label: "3-bit Adder", description: "A logic component used within the timer and calculation modules to handle binary additions and signal processing." },
    { src: "Insertion Sort Module.png", label: "Insertion Sort Module", description: "When toggled, it compares new race times against top 10 records, inserting better scores and shifting others down." },
    { src: "Insertion Sort Unit.png", label: "Insertion Sort Unit", description: "Optimized (in terms of wiring footprint) sorting cell used within the insertion sort module. Stores one player's data and handles the comparison logic to determine rank placement." },
    ...
    { src: "26-Bit 4gt Serial Binary Box Decoder.png", label: "26-Bit 4gt Serial Binary Box Decoder", description: "Decodes the 26-bit serial signal back into usable parallel data for the display or storage systems with 4-gametick speed." },
    { src: "23-Bit Mini Time Display.png", label: "23-Bit Mini Time Display", description: "A compact display module handling precise time visualizations during the race." },
    ...
    { src: "Instant Item Catcher (Separates Boat and ID).png", label: "Instant Item Catcher (Separates Boat and ID)", description: "The finish line mechanism. Instantly separates inputs from the player's boat and their ID card to trigger the finish logic." },
];
